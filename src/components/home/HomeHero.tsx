      ...
      <div className="miyo-container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <Button size="lg" className="bg-miyo-800 hover:bg-miyo-700 text-white px-8 py-4 h-auto text-lg font-medium" onClick={handleEmpezarAhora}>Empieza Ahora</Button>
          </div>
        </div>
      </div>
    </section>;
