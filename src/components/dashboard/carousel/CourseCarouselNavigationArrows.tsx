...
interface CourseCarouselNavigationArrowsProps {
  isMobile: boolean;
...
const CourseCarouselNavigationArrows: React.FC<CourseCarouselNavigationArrowsProps> = ({
  isMobile,
  coursesLength,
  canScrollPrev,
  canScrollNext,
...
export default CourseCarouselNavigationArrows;
